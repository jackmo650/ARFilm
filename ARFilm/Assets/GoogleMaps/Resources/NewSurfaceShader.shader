    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb34){
        ...
        u_xlat31 = u_xlat31 * FGlobals.unity_SpecCube1_HDR.y;
    ...
    u_xlat6.xyz = float3(u_xlat31) * FGlobals._Color.xyz;
    ...
    u_xlat12.x = fma(abs(u_xlat30), u_xlat2.x, u_xlat20);
    u_xlat2.x = fma(u_xlat1.x, u_xlat2.x, u_xlat20);
    u_xlat30 = abs(u_xlat30) * u_xlat2.x;
    u_xlat30 = fma(u_xlat1.x, u_xlat12.x, u_xlat30);
    u_xlat30 = u_xlat30 + 9.99999975e-06;
    u_xlat30 = 0.5 / u_xlat30;
    u_xlat2.x = u_xlat20 * u_xlat20;
    u_xlat12.x = fma(u_xlat11, u_xlat2.x, (-u_xlat11));
    u_xlat11 = fma(u_xlat12.x, u_xlat11, 1.0);
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD2.xyz = fma(VGlobals.unity_SHC.xyz, float3(u_xlat6), u_xlat0.xyz);
    output.TEXCOORD4 = float4(0.0, 0.0, 0.0, 0.0);
    output.TEXCOORD5 = float4(0.0, 0.0, 0.0, 0.0);
    return output;
}
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb34){
        ...
        u_xlat2.xyz = (bool(u_xlatb2)) ? u_xlat13.xyz : input.TEXCOORD1.xyz;
        u_xlat2.xyz = u_xlat2.xyz + (-FGlobals.unity_ProbeVolumeMin.xyzx.xyz);
        u_xlat2.yzw = u_xlat2.xyz * FGlobals.unity_ProbeVolumeSizeInv.xyzx.xyz;
    ...
    u_xlat13.x = (-FGlobals._Glossiness) + 1.0;
    u_xlat24 = dot((-u_xlat1.xyz), input.TEXCOORD0.xyz);
    u_xlat24 = u_xlat24 + u_xlat24;
    u_xlat3.xyz = fma(input.TEXCOORD0.xyz, (-float3(u_xlat24)), (-u_xlat1.xyz));
    ...
    if(u_xlatb34){
        ...
        u_xlat4.xyz = (bool(u_xlatb34)) ? u_xlat4.xyz : input.TEXCOORD1.xyz;
    ...
    u_xlat4.xyz = u_xlat5.xyz + input.TEXCOORD2.xyz;
    ...
    u_xlat5.xyz = FGlobals._Color.xyz + float3(-0.0399999991, -0.0399999991, -0.0399999991);
    ...
    u_xlat7.xyz = float3(u_xlat34) * FGlobals._Color.xyz;
    ...
    u_xlat3.x = fma(abs(u_xlat33), u_xlat13.x, u_xlat22);
    u_xlat13.x = fma(u_xlat1.x, u_xlat13.x, u_xlat22);
    u_xlat33 = abs(u_xlat33) * u_xlat13.x;
    u_xlat33 = fma(u_xlat1.x, u_xlat3.x, u_xlat33);
    u_xlat33 = u_xlat33 + 9.99999975e-06;
    u_xlat33 = 0.5 / u_xlat33;
    u_xlat13.x = u_xlat22 * u_xlat22;
    u_xlat3.x = fma(u_xlat12, u_xlat13.x, (-u_xlat12));
    ...
    u_xlat1.x = (-u_xlat34) + FGlobals._Glossiness;
    u_xlat1.x = u_xlat1.x + 1.0;
    u_xlat1.x = clamp(u_xlat1.x, 0.0f, 1.0f);
    u_xlat3.xyz = fma(u_xlat2.xzw, u_xlat11.xxx, u_xlat4.xyz);
    u_xlat2.xyz = u_xlat2.xzw * float3(u_xlat33);
    u_xlat0.x = (-u_xlat0.x) + 1.0;
    u_xlat11.x = u_xlat0.x * u_xlat0.x;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb2){
        ...
        u_xlat24.x = fma((-FGlobals.unity_ProbeVolumeParams.z), 0.5, 0.25);
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.TEXCOORD2.xyz = u_xlat0.xyz + u_xlat2.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat6.xyz = float3(u_xlat22) * FGlobals._Color.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat18 = rsqrt(u_xlat18);
    u_xlat1.xyz = float3(u_xlat18) * u_xlat0.xyz;
    u_xlat2.xy = input.TEXCOORD1.yy * FGlobals.hlslcc_mtx4x4unity_WorldToLight[1].xy;
    u_xlat2.xy = fma(FGlobals.hlslcc_mtx4x4unity_WorldToLight[0].xy, input.TEXCOORD1.xx, u_xlat2.xy);
    u_xlat2.xy = fma(FGlobals.hlslcc_mtx4x4unity_WorldToLight[2].xy, input.TEXCOORD1.zz, u_xlat2.xy);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb2){
        ...
        u_xlat2.xyz = (bool(u_xlatb2)) ? u_xlat9.xyz : input.TEXCOORD1.xyz;
        u_xlat2.xyz = u_xlat2.xyz + (-FGlobals.unity_ProbeVolumeMin.xyzx.xyz);
        u_xlat2.yzw = u_xlat2.xyz * FGlobals.unity_ProbeVolumeSizeInv.xyzx.xyz;
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat19 = fma(FGlobals.unity_ShadowFadeCenterAndType.w, u_xlat14, u_xlat19);
    u_xlat19 = fma(u_xlat19, FGlobals._LightShadowData.z, FGlobals._LightShadowData.w);
    u_xlat19 = clamp(u_xlat19, 0.0f, 1.0f);
    ...
    if(u_xlatb14){
        ...
        u_xlat3.xyz = fma(FGlobals.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[2].xyz, input.TEXCOORD1.zzz, u_xlat3.xyz);
        u_xlat3.xyz = u_xlat3.xyz + FGlobals.hlslcc_mtx4x4unity_ProbeVolumeWorldToObject[3].xyz;
        u_xlat3.xyz = (bool(u_xlatb14)) ? u_xlat3.xyz : input.TEXCOORD1.xyz;
        u_xlat3.xyz = u_xlat3.xyz + (-FGlobals.unity_ProbeVolumeMin.xyzx.xyz);
        u_xlat3.yzw = u_xlat3.xyz * FGlobals.unity_ProbeVolumeSizeInv.xyzx.xyz;
    ...
    u_xlat20 = _ShadowMapTexture.sample(sampler_ShadowMapTexture, u_xlat3.xy).x;
    u_xlat14 = (-u_xlat20) + u_xlat14;
    u_xlat19 = fma(u_xlat19, u_xlat14, u_xlat20);
    u_xlat2.x = _LightTexture0.sample(sampler_LightTexture0, u_xlat2.xy).w;
    u_xlat19 = u_xlat19 * u_xlat2.x;
    u_xlat2.xyz = float3(u_xlat19) * FGlobals._LightColor0.xyz;
    u_xlat19 = dot(input.TEXCOORD0.xyz, input.TEXCOORD0.xyz);
...
Set 2D Texture "_LightTexture0" to slot 0 sampler slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 1 sampler slot 0
Set CUBE Texture "_ShadowMapTexture" to slot 2 sampler slot 1
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat2.x = dot(u_xlat2, FGlobals.unity_OcclusionMaskSelector);
    u_xlat2.x = clamp(u_xlat2.x, 0.0f, 1.0f);
    u_xlat9.xyz = input.TEXCOORD1.xyz + (-FGlobals._LightPositionRange.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    if(u_xlatb9){
        ...
        u_xlat5.x = _ShadowMapTexture.sample_compare(sampler_ShadowMapTexture, u_xlat5.xyz, saturate(u_xlat24), level(0.0));
        u_xlat6.xyz = u_xlat9.xyz + float3(-0.0078125, -0.0078125, 0.0078125);
        u_xlat5.y = _ShadowMapTexture.sample_compare(sampler_ShadowMapTexture, u_xlat6.xyz, saturate(u_xlat24), level(0.0));
        u_xlat6.xyz = u_xlat9.xyz + float3(-0.0078125, 0.0078125, -0.0078125);
        u_xlat5.z = _ShadowMapTexture.sample_compare(sampler_ShadowMapTexture, u_xlat6.xyz, saturate(u_xlat24), level(0.0));
        u_xlat9.xyz = u_xlat9.xyz + float3(0.0078125, -0.0078125, -0.0078125);
        u_xlat5.w = _ShadowMapTexture.sample_compare(sampler_ShadowMapTexture, u_xlat9.xyz, saturate(u_xlat24), level(0.0));
        u_xlat9.x = dot(u_xlat5, float4(0.25, 0.25, 0.25, 0.25));
        u_xlat16 = (-FGlobals._LightShadowData.x) + 1.0;
        u_xlat9.x = fma(u_xlat9.x, u_xlat16, FGlobals._LightShadowData.x);
    } else {
        u_xlat9.x = 1.0;
...
-- Hardware tier variant: Tier 1
-- Fragment shader for "metal":
Set 2D Texture "_LightTextureB0" to slot 0 sampler slot 3
Set CUBE Texture "_LightTexture0" to slot 1 sampler slot 2
Set 3D Texture "unity_ProbeVolumeSH" to slot 2 sampler slot 0
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat9.x = _LightTexture0.sample(sampler_LightTexture0, u_xlat4.xyz).w;
    u_xlat2.x = u_xlat9.x * u_xlat2.x;
    u_xlat22 = u_xlat22 * u_xlat2.x;
    u_xlat2.xyz = float3(u_xlat22) * FGlobals._LightColor0.xyz;
    u_xlat22 = dot(input.TEXCOORD0.xyz, input.TEXCOORD0.xyz);
    ...
    Mtl_FragmentIn input [[ stage_in ]])
{
    ...
    u_xlat1.xyz = float3(u_xlat12) * FGlobals._Color.xyz;
